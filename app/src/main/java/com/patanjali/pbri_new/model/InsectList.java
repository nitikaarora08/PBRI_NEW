...
public class InsectList {
    ...
    @SerializedName("irrigation_lang")
    private String mIrrigationLang;
    ...
    public String getIrrigationLang() {
        return mIrrigationLang;
    }

    public void setIrrigationLang(String irrigationLang) {
        mIrrigationLang = irrigationLang;
    }
