...
// */
//
//public class PestObservedCustomAdpter extends Adapter<PestObservedCustomAdpter.MyViewHolder> {
//    ThreeFragment context;
//    ListFarmBook<InsectList> arr=new ArrayList<>();
//
//    public PestObservedCustomAdpter(ThreeFragment context, ListFarmBook<InsectList> arr) {
