...
// */
//
//public class DiseaseObservedCustomAdpter extends Adapter<DiseaseObservedCustomAdpter.MyViewHolder> {
//    ThreeFragment context;
//    ListFarmBook<DeseaseList> arr=new ArrayList<>();
//
//    public DiseaseObservedCustomAdpter(ThreeFragment context, ListFarmBook<DeseaseList> arr) {
